...
import { getPropsForPage } from '../../../../packages/open-api-page/utils/routing-utils'
import Aside from '../../../../packages/aside'
import CodeBlock from '../../../../packages/code-block'

function StaticPropsDecorator(Story, { args }) {
  const { swaggerJson, pageSlug, ...restArgs } = args
  const staticProps = getPropsForPage(swaggerJson, { page: [pageSlug] })
